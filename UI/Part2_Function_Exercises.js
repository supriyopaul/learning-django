...
function caught_speeding(speed, is_birthday){
    var smallTicketLimit = 60;
    var bigTicketLimit = 80;
    if(is_birthday){
        smallTicketLimit = smallTicketLimit + 5;
        bigTicketLimit = bigTicketLimit + 5;
    }
    var ticket = 0;
    if(speed > smallTicketLimit && speed <= bigTicketLimit){
        ticket = 1;
    }
    if(speed > bigTicketLimit){
         ticket = 2;
    }
    return ticket; 
}
